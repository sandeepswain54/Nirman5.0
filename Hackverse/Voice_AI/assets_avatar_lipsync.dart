...
class AssetsAvatarLipSync extends StatefulWidget {
  final String avatarImagePath; // Your assets image path
  
  const AssetsAvatarLipSync({Key? key, required this.avatarImagePath}) : super(key: key);

  @override
  _AssetsAvatarLipSyncState createState() => _AssetsAvatarLipSyncState();
}

class _AssetsAvatarLipSyncState extends State<AssetsAvatarLipSync> 
  ...
  // Animation controllers for lip sync
  late AnimationController _mouthController;
  late AnimationController _blinkController;
  bool _isSpeaking = false;
  bool _isBlinking = false;

  // Lip position (adjust these based on your demo.png)
  double _lipTopPosition = 140; // Adjust based on your image
  double _lipLeftPosition = 75;  // Adjust based on your image
  double _lipWidth = 60;         // Adjust based on your image
  ...
  Widget _buildAvatarWithLipSync() {
    return Container(
      width: 280,
      height: 280,
      child: Stack(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                image: AssetImage(widget.avatarImagePath), // Using AssetImage
                fit: BoxFit.cover,
              ),
              boxShadow: [
                BoxShadow(
          ...
          Positioned(
            top: _lipTopPosition,
            left: _lipLeftPosition,
            child: AnimatedBuilder(
              animation: _mouthController,
              builder: (context, child) {
                return Container(
                  width: _lipWidth,
                  height: _isSpeaking ? (8 + _mouthController.value * 12) : 0,
                  decoration: BoxDecoration(
          ...
          // Blinking Eyes Overlay (optional)
          if (_isBlinking)
            Positioned(
              top: 80, // Adjust based on your image
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                SizedBox(width: 8),
                Text(
                  _speechAvailable ? 'Ready for conversation' : 'Microphone required',
                ),
              ],
            ),
          ),
