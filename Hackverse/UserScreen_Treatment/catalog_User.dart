...
class Productuser extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            DefaultTabController(
              ...
              child: Padding(
                ...
                child: TabBar(
                  ...
                  tabs: const [
                    Tab(text: "Products"), // Removed Inventory and Categories tabs
                  ],
                ),
              ),
            ),
      ...
      // Removed the floating action button completely
    );
  }
  ...
  void _showProductDetails(BuildContext context, Map<String, dynamic> prod) {
